...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mup/node_modules/mup/lib/validate/meteor.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mup/node_modules/mup/lib/validate/meteor.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mup/node_modules/mup/lib/validate/</a> &#187; meteor.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  details = (0, _utils.combineErrorDetails)(details, _joi2.default.validate(config.meteor, schema, _utils.VALIDATE_OPTIONS));</span>
<span class="cstat-no" title="statement not covered" >  if (config.meteor.name.indexOf(' ') &gt; -1) {</span>
<span class="cstat-no" title="statement not covered" >    details.push({</span>
      message: '"name" has a space'
    });
  }
<span class="cstat-no" title="statement not covered" >  details = (0, _utils.combineErrorDetails)(details, (0, _utils.serversExist)(config.servers, config.meteor.servers));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return (0, _utils.addLocation)(details, 'meteor');</span>
};
&nbsp;
