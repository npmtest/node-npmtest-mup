...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mup/node_modules/mup/lib/modules/default/commands.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mup/node_modules/mup/lib/modules/default/commands.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mup/node_modules/mup/lib/modules/default/</a> &#187; commands.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function commands(parser) {</span>
<span class="cstat-no" title="statement not covered" >  return parser.command('init', 'Setup files for new mup project', {}, commandFunctions.init).command('deploy', 'Deploy app to servers', <span class="fstat-no" title="function not covered" >function (yargs) {</span></span>
<span class="cstat-no" title="statement not covered" >    return yargs.option('cached-build', {</span>
      description: 'Use build from previous deploy',
      boolean: true
    });
  }, commandFunctions.deploy).command('logs', "Show app's logs. Supports options from docker logs", <span class="fstat-no" title="function not covered" >function (yargs) {</span>
<span class="cstat-no" title="statement not covered" >    return yargs.strict(false).option('tail', {</span>
